...
import { RefreshControl, FlatList, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
        ...
        await fetch(env.api + "customer/booking/" + customer.customerId + "/" + bookId, {
            ...
            .then(data => {
                if (data.error) {
                    ...
                    // this.emptyStorage();
                    this.hideLoader();
                    this.props.navigation.navigate('summary', { booking: data.bookingDetails });
