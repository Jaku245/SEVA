...
import { SafeAreaView, Image, PermissionsAndroid, Platform, StyleSheet, Text, View, TouchableOpacity, Dimensions, KeyboardAvoidingView, ScrollView, Modal, FlatList, Alert } from 'react-native';
