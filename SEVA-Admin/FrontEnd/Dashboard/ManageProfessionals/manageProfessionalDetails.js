...
class manageProfessionalDetails extends Component {
            ...
            return (
                <Card key={s._id} containerStyle={styles.card}>
                    ...
                    <View style={styles.briefBottom}>
                        <TouchableOpacity style={styles.statusBtn}
                            onPress={() => {
                                this.props.navigation.navigate('professionalServiceDetails', { booking: s });
                            }}
                        >
    ...
    flagCustomer(id) {
        fetch(env.api + "admin/flag/professional/" + id + "/" + this.state.admin.adminId, {
            method: "PUT",
            headers: {
    ...
    async fetchProfessionals() {
        await fetch(env.api + "admin/view/professional/" + this.state.user._id, {
            method: "GET",
            headers: {
                "Authorization": 'Bearer ' + this.state.token
            }
...
export default manageProfessionalDetails;
