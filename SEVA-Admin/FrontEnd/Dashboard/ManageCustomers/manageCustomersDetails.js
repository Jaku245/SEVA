...
class manageCustomerDetails extends Component {
                ...
                return (
                    <Card key={s._id} containerStyle={styles.card}>
                        ...
                        <View style={styles.briefBottom}>
                            <TouchableOpacity style={styles.statusBtn}
                                onPress={() => {
                                    this.props.navigation.navigate('customerServiceDetails', { booking: s });
                                }}
                            >
    ...
    async fetchCustomer() {
        await fetch(env.api + "admin/view/customer/" + this.state.user._id, {
            method: "GET",
            headers: {
                "Authorization": 'Bearer ' + this.state.token
            }
