...
class addSubCategory extends Component {
    ...
    async onAddSubCategory() {
        ...
        await fetch(env.api + "admin/subcategory/create/" + this.state.cat._id, {
            method: "POST",
            headers: {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    />
                    <Text style={styles.headerText}>Add sub category</Text>
                </View>
                ...
                <View style={styles.selectDateTimeButton}>
                    <TouchableOpacity style={styles.selectDateTimeButtonOpacity} onPress={() => {
                        ...
                        <Text style={styles.selectDateTimeButtonText}>Add Sub Category</Text>
